	...
	return (
		<LampContainer>
			<motion.h1
				...
				className='mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent dark:from-slate-400 dark:to-slate-600 md:text-7xl'
			>
...
export const LampContainer = ({
	...
	return (
		<div
			className={cn(
				'relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white dark:bg-gray-900 w-full rounded-md z-0',
				className
			)}
		>
			<div className='relative flex w-full flex-1 items-center justify-center isolate z-0'>
				<motion.div
					...
					className='absolute inset-auto right-1/2 h-56 w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white dark:text-black [--conic-position:from_70deg_at_center_top]'
				>
				...
				<motion.div
					...
					className='absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white dark:text-black [--conic-position:from_290deg_at_center_top]'
				>
